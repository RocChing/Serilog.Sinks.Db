...
namespace Serilog.Sinks.Db
{
    ...
    /// </summary>
    public static class ApplyMicrosoftExtensionsConfiguration
    {
        /// <summary>
        ...
        public static string GetConnectionString(string nameOrConnectionString, IConfiguration appConfiguration)
        {
            ...
            {
                Console.WriteLine("MSSqlServer sink configured value {0} is not found in ConnectionStrings settings and does not appear to be a raw connection string.", nameOrConnectionString);
            }
            return cs;
        }
